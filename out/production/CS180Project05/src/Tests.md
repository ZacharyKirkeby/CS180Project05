...
"Added Product Quantity" page OR the "Product Removed from Cart" page and the number of products in view shopping cart has increased/ decreased as expected.
